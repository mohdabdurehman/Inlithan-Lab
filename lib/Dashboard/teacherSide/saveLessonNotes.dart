...
class saveLessonNotesT extends StatefulWidget {
  const saveLessonNotesT({super.key});

  @override
  State<saveLessonNotesT> createState() => _saveLessonNotesTState();
}

class _saveLessonNotesTState extends State<saveLessonNotesT> {
                              ...
                              Row(
                                children: [
                                  Icon(Icons.save_rounded,
                                      color: Color(0xff00b764), size: 20),
                                  SizedBox(width: 8),
                                  Text(
                                    'Save',
                                    style: GoogleFonts.raleway(
