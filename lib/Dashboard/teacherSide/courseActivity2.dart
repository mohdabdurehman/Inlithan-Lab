...
class CourseActivities2T extends StatefulWidget {
  const CourseActivities2T({super.key});

  @override
  State<CourseActivities2T> createState() => CourseActivities2TState();
}

class CourseActivities2TState extends State<CourseActivities2T> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isExpanded ? const Color(0xffb75b00) : const Color(0xff152826),
            width: 1,
          ),
        ),
        child: Column(
                      ...
                      children: [
                        OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: const BorderSide(
                                color: Color(0xffb75b00), width: 1.5),
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(8)),
                            padding: const EdgeInsets.symmetric(
