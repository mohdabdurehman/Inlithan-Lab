...
class QuizScreenT extends StatefulWidget {
  const QuizScreenT({super.key});

  @override
  State<QuizScreenT> createState() => _QuizScreenTState();
}

class _QuizScreenTState extends State<QuizScreenT> {
  int _currentIndex = 0;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...List.generate(q['answers'].length, (i) {
                      final bool isSelected = i == q['correct'];
                      return Container(
                        width: double.infinity,
